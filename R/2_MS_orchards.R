...
dir.create("Data/1_DataProcessing/meta_analyses/png/orchard/main/")
...
orchardPlotFunc = function(fi, coul){
    ...
    output_filename = paste0("Data/1_DataProcessing/meta_analyses/png/orchard/main/", mod, "_orchard.png")
...
model_files = c(
    "Data/1_DataProcessing/meta_analyses/models/marg_group:group_proxy.rds",
    "Data/1_DataProcessing/meta_analyses/models/risk_group:risk_proxy.rds",
    "Data/1_DataProcessing/meta_analyses/models/marg_group:risk_group.rds",
    # extra standalone plots
    "Data/1_DataProcessing/meta_analyses/models/transmission:broad_region.rds"
)
...
ggsave(
    "Data/1_DataProcessing/meta_analyses/png/orchard/main/main_fig_facet.png", scale=2, width=2040, height=1080, units='px'
)
...
orchardPlotFuncWithK = function(fi, coul){
    ...
    #Declare output file
    output_filename = paste0("Data/1_DataProcessing/meta_analyses/png/orchard/main/", mod, "_orchard_withK.png")
...
ggsave(
    "Data/1_DataProcessing/meta_analyses/png/orchard/main/main_fig_facet_withK.png", scale=2, width=2040, height=1080, units='px'
)
