...
dir.create("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio")
...
ma.intercept = readRDS("Data/1_DataProcessing/meta_analyses/models/intercept_only.rds")
ma.marg_group = readRDS("Data/1_DataProcessing/meta_analyses/models/marg_group:NULL.rds")
ma.risk_group = readRDS("Data/1_DataProcessing/meta_analyses/models/risk_group:NULL.rds")
ma.transmission = readRDS("Data/1_DataProcessing/meta_analyses/models/transmission:NULL.rds")
ma.country = readRDS("Data/1_DataProcessing/meta_analyses/models/country:NULL.rds")
ma.data_source = readRDS("Data/1_DataProcessing/meta_analyses/models/data_source:NULL.rds")
ma.scale = readRDS("Data/1_DataProcessing/meta_analyses/models/scale:NULL.rds")
ma.group_proxy = readRDS("Data/1_DataProcessing/meta_analyses/models/group_proxy:NULL.rds")
...
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/facet_fig_3x2.png", scale = 4, units = 'px', width=2040, height=1080)

facet_fig_2x3 = facet_fig +
    facet_wrap(~analysis, nrow = 2, scales = "free_y") 
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/facet_fig_2x3.png", scale = 4, units = 'px',width=1080, height=2040)
...
figure1.1
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/intercept_marg_group.png", scale = 2.22)
figure1.2
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/risk_group.png", scale = 2.22)
figure1.3
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/transmission.png", scale = 2.22)
figure2.1
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/country.png", scale = 2.22)
figure2.2
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/data_source.png", scale = 2.22)
figure2.3
ggsave("Data/1_DataProcessing/meta_analyses/png/log_odds_ratio/scale.png", scale = 2.22)


# Table for each of the main effects --------------------------------------

#KMS needed this for manuscript
ma.group_proxy.transmission = readRDS("Data/1_DataProcessing/meta_analyses/models/group_proxy:transmission.rds")
...
write_csv(table_061225, "Data/1_DataProcessing/meta_analyses/stats/main_effects_table.csv") 
