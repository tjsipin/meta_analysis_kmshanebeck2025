...
funnelPlotFunc = function(fi){
    ...
    #Set plot path
    png(paste0("results/png/funnel/se/", mod, "_se.png"))
    funnel_se = funnel(
    ...
    png(paste0("results/png/funnel/vi/", mod, "_vi.png"))
    funnel_vi = funnel(
    ...
    png(paste0("results/png/funnel/seinv/", mod, "_seinv.png"))
    funnel_seinv = funnel(
    ...
    png(paste0("results/png/funnel/vinv/", mod, "_vinv.png"))
    funnel_vinv = funnel(
...
orchardPlotFunc = function(fi){
    ...
    #Intercept-only plot
    if(is.na(mod)){
        output_filename = paste0("results/png/orchard/intercept_orchard.png")
    ...
    output_filename = paste0("results/png/orchard/", mod, "_orchard.png")
    # if(file.exists(output_filename)) return(NULL)
...
dir.create("results/png/funnel/se", recursive=T)
dir.create("results/png/funnel/seinv", recursive=T)
dir.create("results/png/funnel/vi", recursive=T)
dir.create("results/png/funnel/vinv", recursive=T)
dir.create("results/png/orchard", recursive=T)
